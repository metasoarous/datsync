...
var G__39390 = o;
(G__39390[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__10207__auto__ = !((jsprops == null));
if(and__10207__auto__){
var and__10207__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__39399 = jsprops;
(G__39399["defaultValue"] = value);

(G__39399["onChange"] = ((function (G__39399,v,value,on_change){
return (function (p1__39396_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__39396_SHARP_);
});})(G__39399,v,value,on_change))
);

(G__39399["ref"] = ((function (G__39399,v,value,on_change){
return (function (p1__39397_SHARP_){
return (this$["cljsInputElement"] = p1__39397_SHARP_);
});})(G__39399,v,value,on_change))
);
...
var vec__39406 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__39406,(0),null);
var id = cljs.core.nth.call(null,vec__39406,(1),null);
var class$ = cljs.core.nth.call(null,vec__39406,(2),null);
...
var jsprops = ({"argv": v});
var temp__6742__auto___39411 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6742__auto___39411 == null)){
} else {
var key_39412 = temp__6742__auto___39411;
(jsprops["key"] = key_39412);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__39414 = (new reagent.impl.template.NativeWrapper());
(G__39414["name"] = c);
...
var len__11440__auto___39420 = arguments.length;
var i__11441__auto___39421 = (0);
while(true){
if((i__11441__auto___39421 < len__11440__auto___39420)){
args__11447__auto__.push((arguments[i__11441__auto___39421]));

var G__39422 = (i__11441__auto___39421 + (1));
i__11441__auto___39421 = G__39422;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__11448__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq39418){
var G__39419 = cljs.core.first.call(null,seq39418);
var seq39418__$1 = cljs.core.next.call(null,seq39418);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__39419,seq39418__$1);
});
...
break;
default:
var G__39426 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__39426;
continue;
...
var n__11240__auto___39429 = a.length;
var i_39430 = (0);
while(true){
if((i_39430 < n__11240__auto___39429)){
(a[i_39430] = reagent.impl.template.as_element.call(null,(a[i_39430])));

var G__39431 = (i_39430 + (1));
i_39430 = G__39431;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__11240__auto___39432 = a.length;
var i_39433 = (0);
while(true){
if((i_39433 < n__11240__auto___39432)){
var val_39434 = (a[i_39433]);
if((cljs.core.vector_QMARK_.call(null,val_39434)) && ((reagent.impl.template.key_from_vec.call(null,val_39434) == null))){
(o["no-key"] = true);
} else {
}

(a[i_39433] = reagent.impl.template.as_element.call(null,val_39434));

var G__39435 = (i_39433 + (1));
i_39433 = G__39435;
continue;
} else {
}
...
var ctx = ({});
var vec__39439 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__39439,(0),null);
var derefed = cljs.core.nth.call(null,vec__39439,(1),null);
...
var G__39443 = (cljs.core.count.call(null,argv) - first_child);
switch (G__39443) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__39443){
